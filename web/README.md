...
The hint uses the same 256-world search as the Expert bot. Place is your
expected finish (1 is a sole win, 4 is last); round EV is expected penalty
points. Lower is better for both.
